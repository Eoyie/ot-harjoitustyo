...
class TestKassapaate(unittest.TestCase):
    ...
    def test_muut(self):
        ...
        self.assertEqual(self.kassapaate.kassa(), 100000)
        self.assertEqual(self.kassapaate.edullinen(), 0)
        self.assertEqual(self.kassapaate.maukas(), 0)

    def test_kateisnosto_toimii_raha_ja_lounari_oikein_edullinen(self):
        self.kassapaate.syo_edullisesti_kateisella(240)
        
        self.assertEqual(self.kassapaate.kassa(), 100240)
        self.assertEqual(self.kassapaate.edullinen(), 1)
    ...
    def test_kateisnosto_toimii_raha_ja_lounari_oikein_maukas(self):
        ...
        self.assertEqual(self.kassapaate.kassa(), 100400)
        self.assertEqual(self.kassapaate.maukas(), 1)
    ...
    def test_lataus_toimii(self):
        ...
        self.assertEqual(self.kassapaate.kassa(), 100050)
